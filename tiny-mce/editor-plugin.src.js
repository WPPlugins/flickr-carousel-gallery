...
(function() {
	...
	tinymce.PluginManager.requireLangPack('flickr_carousel_gallery');
	...
	tinymce.create('tinymce.plugins.ExamplePlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceExample', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 620 + ed.getLang('flickr_carousel_gallery.delta_width', 0),
					height : 420 + ed.getLang('flickr_carousel_gallery.delta_height', 0),
					inline : 1
				}, {
			...
			ed.addButton('flickr_carousel_gallery', {
				title : 'flickr_carousel_gallery.desc',
				cmd : 'mceExample',
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('flickr_carousel_gallery', n.nodeName == 'IMG');
			});
		},
		...
		getInfo : function(){
            return {
                longname : "Flickr Carousel gallery",
                author : 'Ramandeep Singh',
                authorurl : 'http://designaeon.com/',
                infourl : 'http://designaeon.com/',
                version : "1.0"
            };
        }
	});
	...
	// Register plugin
	tinymce.PluginManager.add('flickr_carousel_gallery', tinymce.plugins.ExamplePlugin);
})();
